...
<!-- <a href="https://twitter.com/intent/tweet?text=<?php echo rawurlencode ($page->share()); ?>&url=<?php echo rawurlencode($page->tinyurl()); ?>&hashtags=<?php foreach($page->tags()->split(', ') as $tag): ?>%20<?php echo ($tag); ?><?php endforeach ?>&via=CuriosityColoredGlasses" title="Share on Twitter" target="_blank">
