...
<?php endif ?>
                ...
                <details id="postacommentdetails"> <!-- OPENING THE TEST FOR "POST A COMMENT" BUTTON -->

                    <summary id="postacommentsummary" class="xs-display postacomment">Post a comment</summary>
                ...
                </details>    <!-- CLOSING THE TEST FOR "POST A COMMENT" BUTTON -->
