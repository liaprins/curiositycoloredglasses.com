...
function lightbox(imgToShow) {
    ...
    singleLightbox.innerHTML = singleLightbox.parentNode.innerHTML + '<img src="http://localhost:8888/kirby-project/kirby-2.5.8/assets/images/x.svg" alt="close" id="lightboxclose" class="close-x yellowhover" data-lightbox-x>';
    ...
    if (caption) {
        ...
        // !!! or store the PHP version in an HTML element's attribute, then collect it in JS as a variable and call it here
        // !!! or else construct its shape with CSS (research performance) vvv
        toggle.setAttribute('src', 'http://localhost:8888/kirby-project/kirby-2.5.8/assets/images/up-arrowhead.svg');
...
function populateLightboxDots(imgToShow) {
    ...
    if (imgToShow.getAttribute('id') == ('galleryimage')) {
        ...
        lightboxArrowContainer.innerHTML = '<img src="http://localhost:8888/kirby-project/kirby-2.5.8/assets/images/left-arrowhead.svg" alt="retreat" title="Previous image" class="galleryarrows lightboxarrows yellowhover" data-retreatlightboxarrow>' + '<img src="http://localhost:8888/kirby-project/kirby-2.5.8/assets/images/right-arrowhead.svg" alt="advance" title="Next image" class="galleryarrows lightboxarrows yellowhover" data-advancelightboxarrow>';
...
function slideshow() {    
    ...
    for (i = 0; i < galleryList.length; i++) {
        ...
        arrowContainer.innerHTML = '<img src="http://localhost:8888/kirby-project/kirby-2.5.8/assets/images/left-arrowhead.svg" alt="retreat" title="Previous image" class="galleryarrows yellowhover" data-retreatarrow>' + '<img src="http://localhost:8888/kirby-project/kirby-2.5.8/assets/images/right-arrowhead.svg" alt="advance" title="Next image" class="galleryarrows yellowhover" data-advancearrow>';
        ...
        for (j = 0; j < (galleryList[i].children.length - 3); j++) {
            ...
            dot.innerHTML = '<img src="http://localhost:8888/kirby-project/kirby-2.5.8/assets/images/dot.svg" alt="go to this slide" class="dotimg dotimgunfilled">';
            ...
            dotsList[0].innerHTML = '<img src="http://localhost:8888/kirby-project/kirby-2.5.8/assets/images/dot-filled.svg" alt="go to this slide" class="dotimg dotimgfill">';
...
function advanceOrRetreat(clickedSideSlide, dotsContainer, gallery, clickedIndex, galleryName, currentSlide) {
    ...
    for (k = 0; k < dotsList.length; k++) {
        if (k == clickedIndex) {
            ...
            dotsList[k].innerHTML = '<img src="http://localhost:8888/kirby-project/kirby-2.5.8/assets/images/dot-filled.svg" alt="go to this slide" class="dotimg dotimgfill">';
        } else {
            dotsList[k].setAttribute('class', 'dot dotunfilled');
            dotsList[k].innerHTML = '<img src="http://localhost:8888/kirby-project/kirby-2.5.8/assets/images/dot.svg" alt="go to this slide" class="dotimg dotimgunfilled">';
        } // close if
    } // close k
...
function clickDot(e) {
    ...
    if (clickedThingGrandparent.getAttribute('id') == 'regviewdotcontainer') {
        ...
        // clickedDot.innerHTML = '<img src="http://localhost:8888/kirby-project/kirby-2.5.8/assets/images/dot-filled.svg" alt="go to this slide" class="dotimg">';
    }  // close if
} // close function
