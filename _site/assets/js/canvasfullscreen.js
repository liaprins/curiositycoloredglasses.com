...
function canvasFullScreen() {
	...
	for (i = 0; i < allCanvas.length; i++) {
		...
		lightboxToggle.setAttribute('src', '/assets/images/sitewide/to-full-screen.svg');
...
function canvasToLightbox(e) {
	...
	if (clickedThing.classList.contains('tofullscreen')) {
		...
		lightboxToggle.setAttribute('src', '/assets/images/sitewide/to-regular-view.svg');
		...
		closeX.setAttribute('src', '/assets/images/sitewide/x.svg');
		...
		if (lightboxToggle.nextElementSibling.hasAttribute('data-canvas-figcaption')) {
			...
			chevron.setAttribute('src', '/assets/images/sitewide/up-arrowhead.svg');
