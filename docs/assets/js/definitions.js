	    	...
	    	for (var i = 0; i < definitionsList.length; i++) {
	    		...
	    		if ((selectedVocab.getAttribute('id')) == ('-' + definitionsList[i].getAttribute('data-definition-id'))) {
	    			...
	    			if (containerCheck) {
    					...
    					// innerContainer
    					containerInner.innerHTML = '<img src="/assets/images/sitewide/x.svg" alt="close" id="vocabclose" class="close-x yellowhover" data-vocab-x>' + definitionsList[i].innerHTML;
	    	...
	    	for (var i = 0; i < notesList.length; i++) {
	    		...
	    		if ((selectedVocab.getAttribute('id')) == ('-' + notesList[i].getAttribute('data-notes-id'))) {
	    			...
	    			if (containerCheck) {
			        	...
			        	// or else construct its shape with CSS (research performance) vvv
    					// innerContainer
    					containerInner.innerHTML = '<img src="/assets/images/sitewide/x.svg" alt="close" id="vocabclose" class="close-x yellowhover" data-vocab-x><span>' + notesList[i].firstElementChild.innerHTML + '</span><p class="xs-textface notecontent">' + notesList[i].firstElementChild.nextElementSibling.innerHTML + '</p>';
