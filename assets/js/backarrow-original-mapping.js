...
function backArrowLibraryOrTag() {
    if ((referredLink.includes('blog\/')) &&
        ...
        document.getElementById("testholder").innerHTML = referredLink + ' *** YES I was directed here from ( blog\/ AND I am now at Library ) *** ' + currentURL;
    } else {
        document.getElementById("testholder").innerHTML = referredLink + ' *** NO I was NOT directed here from ( blog\/ AND I am now at Library ) *** ' + currentURL;
    }
}
*/

function backArrowTag() {
    if ((referredLink.includes('search')) &&
    	// replace "/archive/" with "/tag/" once tag page can run scripts (right now archive page is a substition for testing)
    	(/archive/.test(window.location.href))) {
        document.getElementById("testholder").innerHTML = referredLink + ' *** YES I was directed here from ( search AND I am now at Archive ) *** ' + currentURL;
    } else {
        document.getElementById("testholder").innerHTML = referredLink + ' *** NO I was NOT directed here from ( search AND I am now at Archive ) *** ' + currentURL;
    }
}
