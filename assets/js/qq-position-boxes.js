...
// LARGE -------------------------------------------------------------
    ...
    for (var i = 0; i < largePairRowCountInt; i++) {
        // 1st column
        allLargePairs[i * largeColumnCount].style.left = 'calc(50vw - 612.5px + 50px)';
        allLargePairs[i * largeColumnCount].style.top = ((360 * i) + 50) + 'px';
        // 2nd column
        allLargePairs[(i * largeColumnCount) + 1].style.left = 'calc(50vw - 87.5px)';
        allLargePairs[(i * largeColumnCount) + 1].style.top = ((360 * i) + 50) + 'px';
        // 3rd column
        allLargePairs[(i * largeColumnCount) + 2].style.left = 'calc(50vw + 612.5px - 157px - 50px)';
        allLargePairs[(i * largeColumnCount) + 2].style.top = ((360 * i) + 50) + 'px';
    }

    if (largeRemainder == 1) {
        // last pair; 1st column
        allLargePairs[largePairCount - 1].style.left = 'calc(50vw - 612.5px + 50px)';
        allLargePairs[largePairCount - 1].style.top = ((360 * i) + 50) + 'px';
    }

    if (largeRemainder == 2) {
        // 2nd-to-last pair; 1st column
        allLargePairs[largePairCount - 2].style.left = 'calc(50vw - 612.5px + 50px)';
        allLargePairs[largePairCount - 2].style.top = ((360 * i) + 50) + 'px';
        // last pair; 2nd column
        allLargePairs[largePairCount - 1].style.left = 'calc(50vw - 87.5px)';
        allLargePairs[largePairCount - 1].style.top = ((360 * i) + 50) + 'px';
    }
...
// SMALL -------------------------------------------------------------
    ...
    if (smallRemainder == 4) {
        ...
        allSmallPairs[smallPairCount - 4].style.left = 'calc(50vw - 650px)';
        allSmallPairs[smallPairCount - 4].style.top = ((180 * k) + 150) + 'px';
        // 3rd-to-last pair; 2nd column
        allSmallPairs[smallPairCount - 3].style.left = 'calc(50vw - 400px)';
        allSmallPairs[smallPairCount - 3].style.top = ((180 * k) + 150) + 'px';
        // 2nd-to-last pair; 3rd column
        allSmallPairs[smallPairCount - 2].style.left = 'calc(50vw - 150px)';
        allSmallPairs[smallPairCount - 2].style.top = ((180 * k) + 150) + 'px';
        // last pair; 4th column
        allSmallPairs[smallPairCount - 1].style.left = 'calc(50vw + 150px)';
        allSmallPairs[smallPairCount - 1].style.top = ((180 * k) + 150) + 'px';
    }

    if (smallRemainder == 5) {
        // 5th-to-last pair; 1st column
        allSmallPairs[smallPairCount - 5].style.left = 'calc(50vw - 650px)';
        allSmallPairs[smallPairCount - 5].style.top = ((180 * k) + 150) + 'px';
        // 4th-to-last pair; 2nd column
        allSmallPairs[smallPairCount - 4].style.left = 'calc(50vw - 400px)';
        allSmallPairs[smallPairCount - 4].style.top = ((180 * k) + 150) + 'px';
        // 3rd-to-last pair; 3rd column
        allSmallPairs[smallPairCount - 3].style.left = 'calc(50vw - 150px)';
        allSmallPairs[smallPairCount - 3].style.top = ((180 * k) + 150) + 'px';
        // 2nd-to-last pair; 4th column
        allSmallPairs[smallPairCount - 2].style.left = 'calc(50vw + 150px)';
        allSmallPairs[smallPairCount - 2].style.top = ((180 * k) + 150) + 'px';
        // last pair; 5th column
        allSmallPairs[smallPairCount - 1].style.left = 'calc(50vw + 400px)';
        allSmallPairs[smallPairCount - 1].style.top = ((180 * k) + 150) + 'px';
    }
    */
