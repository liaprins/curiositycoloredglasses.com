    ...
    for (var i = 0; i < largePairRowCountInt; i++) {
        ...
        if (([i] % 2) === 0) {
            if (qqScreenWidth < 1225) {
                // 1st column
                allLargePairs[i * largeColumnCount].style.left = 'calc(50vw - 58.16vw)';
                allLargePairs[i * largeColumnCount].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
                // 2nd column
                allLargePairs[(i * largeColumnCount) + 1].style.left = 'calc(50vw - 19.667vw)';
                allLargePairs[(i * largeColumnCount) + 1].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
                // 3rd column
                allLargePairs[(i * largeColumnCount) + 2].style.left = 'calc(50vw + 19.013vw)';
                allLargePairs[(i * largeColumnCount) + 2].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
            } else {
                // 1st column
            ...
            if (qqScreenWidth < 1225) {
                // 1st column
                allLargePairs[i * largeColumnCount].style.left = 'calc(50vw - 40.31vw)';
                allLargePairs[i * largeColumnCount].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
                // 2nd column
                allLargePairs[(i * largeColumnCount) + 1].style.left = 'calc(50vw - 1.877vw)';
                allLargePairs[(i * largeColumnCount) + 1].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
                // 3rd column
                allLargePairs[(i * largeColumnCount) + 2].style.left = 'calc(50vw + 36.557vw)';
                allLargePairs[(i * largeColumnCount) + 2].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
            } else {
                // 1st column
    ...
    if (([i] % 2) === 0) {
        if (largeRemainder == 1) {
            if (qqScreenWidth < 1225) {
                ...
                allLargePairs[largePairCount - 1].style.left = 'calc(50vw - 58.16vw)';
                allLargePairs[largePairCount - 1].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
            } else {
                // last pair; 1st column
        ...
        if (largeRemainder == 2) {
            if (qqScreenWidth < 1225) {
                ...
                allLargePairs[largePairCount - 2].style.left = 'calc(50vw - 58.16vw)';
                allLargePairs[largePairCount - 2].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
                // last pair; 2nd column
                allLargePairs[largePairCount - 1].style.left = 'calc(50vw - 19.667vw)';
                allLargePairs[largePairCount - 1].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
            } else {
                // 2nd-to-last pair; 1st column
                ...
                // last pair; 2nd column
                allLargePairs[largePairCount - 1].style.left = 'calc(50vw - 241px)';
                allLargePairs[largePairCount - 1].style.top = ((650 * (i / 2)) - 30) + 'px';
            } // close qqScreenWidth
        } // close remainder 2
    } else {
        if (largeRemainder == 1) {
            if (qqScreenWidth < 1225) {
                // last pair; 1st column
                allLargePairs[largePairCount - 1].style.left = 'calc(50vw - 40.31vw)';
                allLargePairs[largePairCount - 1].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
            } else {
                // last pair; 1st column
        ...
        if (largeRemainder == 2) {
            if (qqScreenWidth < 1225) {
                // 2nd-to-last pair; 1st column
                allLargePairs[largePairCount - 2].style.left = 'calc(50vw - 40.31vw)';
                allLargePairs[largePairCount - 2].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
                // last pair; 2nd column
                allLargePairs[largePairCount - 1].style.left = 'calc(50vw - 1.877vw)';
                allLargePairs[largePairCount - 1].style.top = ((53.04 * (i / 2)) - 2.448) + 'vw';
            } else {
                // 2nd-to-last pair; 1st column
...
// MEDIUM -------------------------------------------------------------
    ...
    for (var i = 0; i < mediumPairRowCountInt; i++) {
        ...
        if (([i] % 2) === 0) {
            if (qqScreenWidth < 1225) {
                // 1st column
                allMediumPairs[i * mediumColumnCount].style.left = 'calc(50vw - 44.717vw)';
                allMediumPairs[i * mediumColumnCount].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
                // 2nd column
                allMediumPairs[(i * mediumColumnCount) + 1].style.left = 'calc(50vw - 9.221vw)';
                allMediumPairs[(i * mediumColumnCount) + 1].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
                // 3rd column
                allMediumPairs[(i * mediumColumnCount) + 2].style.left = 'calc(50vw + 26.112vw)';
                allMediumPairs[(i * mediumColumnCount) + 2].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
            } else {
                // 1st column
            ...
            if (qqScreenWidth < 1225) {
                // 1st column
                allMediumPairs[i * mediumColumnCount].style.left = 'calc(50vw - 26.72vw)';
                allMediumPairs[i * mediumColumnCount].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
                // 2nd column
                allMediumPairs[(i * mediumColumnCount) + 1].style.left = 'calc(50vw + 8.61vw)';
                allMediumPairs[(i * mediumColumnCount) + 1].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
                // 3rd column
                allMediumPairs[(i * mediumColumnCount) + 2].style.left = 'calc(50vw + 43.94vw)';
                allMediumPairs[(i * mediumColumnCount) + 2].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
            } else {
                // 1st column
    ...
    if (([i] % 2) === 0) {
        if (mediumRemainder == 1) {
            if (qqScreenWidth < 1225) {
                // last pair; 1st column
                allMediumPairs[mediumPairCount - 1].style.left = 'calc(50vw - 44.717vw)';
                allMediumPairs[mediumPairCount - 1].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
            } else {
                // last pair; 1st column
        ...
        if (mediumRemainder == 2) {
            if (qqScreenWidth < 1225) {
                // 2nd-to-last pair; 1st column
                allMediumPairs[mediumPairCount - 2].style.left = 'calc(50vw - 44.717vw)';
                allMediumPairs[mediumPairCount - 2].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
                // last pair; 2nd column
                allMediumPairs[mediumPairCount - 1].style.left = 'calc(50vw - 9.221vw)';
                allMediumPairs[mediumPairCount - 1].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
            } else {
                // 2nd-to-last pair; 1st column
        ...
        if (mediumRemainder == 1) {
            if (qqScreenWidth < 1225) {
                // last pair; 1st column
                allMediumPairs[mediumPairCount - 1].style.left = 'calc(50vw - 26.72vw)';
                allMediumPairs[mediumPairCount - 1].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
            } else {
                // last pair; 1st column
        ...
        if (mediumRemainder == 2) {
            if (qqScreenWidth < 1225) {
                // 2nd-to-last pair; 1st column
                allMediumPairs[mediumPairCount - 2].style.left = 'calc(50vw - 26.72vw)';
                allMediumPairs[mediumPairCount - 2].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
                // last pair; 2nd column
                allMediumPairs[mediumPairCount - 1].style.left = 'calc(50vw + 8.61vw)';
                allMediumPairs[mediumPairCount - 1].style.top = ((53.04 * (i / 2)) + 11.75) + 'vw';
            } else {
                // 2nd-to-last pair; 1st column
...
// SMALL -------------------------------------------------------------
    ...
    for (var i = 0; i < smallPairRowCountInt; i++) {
        ...
        if (([i] % 4) === 0) {
            if (qqScreenWidth < 1225) {
                // 1st column
                allSmallPairs[i * smallColumnCount].style.left = 'calc(50vw - 34.68vw)';
                allSmallPairs[i * smallColumnCount].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
                // 2nd column
                allSmallPairs[(i * smallColumnCount) + 1].style.left = 'calc(50vw + 3.917vw)';
                allSmallPairs[(i * smallColumnCount) + 1].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
                // 3rd column
                allSmallPairs[(i * smallColumnCount) + 2].style.left = 'calc(50vw + 42.595vw)';
                allSmallPairs[(i * smallColumnCount) + 2].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
            } else {
                // 1st column
        ...
        if ((([i] % 4) - 1) === 0) {
            if (qqScreenWidth < 1225) {
                // 1st column
                allSmallPairs[i * smallColumnCount].style.left = 'calc(50vw - 60.14vw)';
                allSmallPairs[i * smallColumnCount].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
                // 2nd column
                allSmallPairs[(i * smallColumnCount) + 1].style.left = 'calc(50vw - 24.806vw)';
                allSmallPairs[(i * smallColumnCount) + 1].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
                // 3rd column
                allSmallPairs[(i * smallColumnCount) + 2].style.left = 'calc(50vw + 10.61vw)';
                allSmallPairs[(i * smallColumnCount) + 2].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
            } else {
                // 1st column
        ...
        if ((([i] % 4) - 2) === 0) {
            if (qqScreenWidth < 1225) {
                // 1st column
                allSmallPairs[i * smallColumnCount].style.left = 'calc(50vw - 55.24vw)';
                allSmallPairs[i * smallColumnCount].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
                // 2nd column
                allSmallPairs[(i * smallColumnCount) + 1].style.left = 'calc(50vw - 16.81vw)';
                allSmallPairs[(i * smallColumnCount) + 1].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
                // 3rd column
                allSmallPairs[(i * smallColumnCount) + 2].style.left = 'calc(50vw + 21.624vw)';
                allSmallPairs[(i * smallColumnCount) + 2].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
            } else {
                // 1st column
        ...
        if ((([i] % 4) - 3) === 0) {
            if (qqScreenWidth < 1225) {
                // 1st column
                allSmallPairs[i * smallColumnCount].style.left = 'calc(50vw - 42.106vw)';
                allSmallPairs[i * smallColumnCount].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
                // 2nd column
                allSmallPairs[(i * smallColumnCount) + 1].style.left = 'calc(50vw - 7.018vw)';
                allSmallPairs[(i * smallColumnCount) + 1].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
                // 3rd column
                allSmallPairs[(i * smallColumnCount) + 2].style.left = 'calc(50vw + 28.315vw)';
                allSmallPairs[(i * smallColumnCount) + 2].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
            } else {
                // 1st column
    ...
    if (([i] % 4) === 0) {
        if (smallRemainder == 1) {
            if (qqScreenWidth < 1225) {
                // last pair; 1st column
                allSmallPairs[smallPairCount - 1].style.left = 'calc(50vw - 34.68vw)';
        ...
        if (smallRemainder == 2) {
            if (qqScreenWidth < 1225) {
                // 2nd-to-last pair; 1st column
                allSmallPairs[smallPairCount - 2].style.left = 'calc(50vw - 34.68vw)';
                allSmallPairs[smallPairCount - 2].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
                // last pair; 2nd column
                allSmallPairs[smallPairCount - 1].style.left = 'calc(50vw + 3.917vw)';
                allSmallPairs[smallPairCount - 1].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
            } else {
                // 2nd-to-last pair; 1st column
    ...
    if ((([i] % 4) - 1) === 0) {
        if (smallRemainder == 1) {
            if (qqScreenWidth < 1225) {
                // last pair; 1st column
                allSmallPairs[smallPairCount - 1].style.left = 'calc(50vw - 60.14vw)';
                allSmallPairs[smallPairCount - 1].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
            } else {
                // last pair; 1st column
        ...
        if (smallRemainder == 2) {
            if (qqScreenWidth < 1225) {
                // 2nd-to-last pair; 1st column
                allSmallPairs[smallPairCount - 2].style.left = 'calc(50vw - 60.14vw)';
                allSmallPairs[smallPairCount - 2].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
                // last pair; 2nd column
                allSmallPairs[smallPairCount - 1].style.left = 'calc(50vw - 24.806vw)';
                allSmallPairs[smallPairCount - 1].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
            } else {
                // 2nd-to-last pair; 1st column
                ...
                allSmallPairs[smallPairCount - 2].style.top = ((325 * (i / 2)) - 7) + 'px';
                // last pair; 2nd column
                allSmallPairs[smallPairCount - 1].style.left = 'calc(50vw - 304px)';
                allSmallPairs[smallPairCount - 1].style.top = ((325 * (i / 2)) - 7) + 'px';
            } // close qqScreenWidth
        } // close remainder 2
    } // close divisible by 4 (2nd row down of 4 horizontal row pattern) 
    ...
    if ((([i] % 4) - 2) === 0) {
        if (smallRemainder == 1) {
            if (qqScreenWidth < 1225) {
                // last pair; 1st column
                allSmallPairs[smallPairCount - 1].style.left = 'calc(50vw - 55.24vw)';
                allSmallPairs[smallPairCount - 1].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
            } else {
                // last pair; 1st column
        ...
        if (smallRemainder == 2) {
            if (qqScreenWidth < 1225) {
                // 2nd-to-last pair; 1st column
                allSmallPairs[smallPairCount - 2].style.left = 'calc(50vw - 55.24vw)';
                allSmallPairs[smallPairCount - 2].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
                // last pair; 2nd column
                allSmallPairs[smallPairCount - 1].style.left = 'calc(50vw - 16.81vw)';
                allSmallPairs[smallPairCount - 1].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
            } else {
                // 2nd-to-last pair; 1st column
    ...
    if ((([i] % 4) - 3) === 0) {
        if (smallRemainder == 1) {
            if (qqScreenWidth < 1225) {
                // last pair; 1st column
                allSmallPairs[smallPairCount - 1].style.left = 'calc(50vw - 42.106vw)';
                allSmallPairs[smallPairCount - 1].style.top = ((26.52 * (i / 2)) - 0.57) + 'vw';
            } else {
                // last pair; 1st column
