...
function getTops() {
    ...
    // SMALL GLASSES
    var smallGlasses = document.getElementsByClassName('small-postglasses');
    ...
    // MEDIUM GLASSES
    var mediumGlasses = document.getElementsByClassName('medium-postglasses');
    ...
    // BIG GLASSES
    var bigGlasses = document.getElementsByClassName('big-postglasses');
